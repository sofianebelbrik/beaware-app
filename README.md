...
The frontend expects an active FastAPI server running locally at http://localhost:8000 with a /predict endpoint accepting latitude and longitude in the request body.
